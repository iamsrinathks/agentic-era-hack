...
def get_sha_workflow_agent():
    ...
    def write_sha_policy_json(multi_file_json_string: str, tool_context: ToolContext) -> dict:
        ...
        Expected payload:
            multi_file_json_string: str  # '=== detector.json ===\n<json>\n=== other.json ===...'
            tool_context: ToolContext

        Returns:
            dict: {"status": "complete" | "error", "message": str}
        """
    ...
    return sha_workflow_agent

sha_workflow_agent = get_sha_workflow_agent()
