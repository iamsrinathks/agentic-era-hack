...
4.  **Process Decision:**
    *   If the user's choice is "Approve", you MUST first respond with the message "Thank you for your approval. Publishing the report to Confluence...". `
        ...
        Also Ensure that the title of the Confluence page is "Product Discovery Report — **<product_name>**", and Add the `ResearchAndCritiqueAgent` final report content to the page.
        After the tool call, confirm completion by saying "The report has been published to Confluence. The discovery process is now complete." This is the final step.
