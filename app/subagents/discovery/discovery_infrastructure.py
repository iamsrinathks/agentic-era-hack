...
#from agent_era_hack.app.subagents.discovery.prompts import return_instructions_discovery_infrastructure
from app.subagents.discovery.prompts import return_instructions_discovery_infrastructure
